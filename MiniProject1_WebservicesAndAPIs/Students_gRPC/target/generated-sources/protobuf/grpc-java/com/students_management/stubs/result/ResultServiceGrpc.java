...
public final class ResultServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.students_management.stubs.result.ResultService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.students_management.stubs.result.ResultRequest,
      com.students_management.stubs.result.ResultResponse> getGetResultForStudentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getResultForStudent",
      requestType = com.students_management.stubs.result.ResultRequest.class,
      responseType = com.students_management.stubs.result.ResultResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.students_management.stubs.result.ResultRequest,
      com.students_management.stubs.result.ResultResponse> getGetResultForStudentMethod() {
    io.grpc.MethodDescriptor<com.students_management.stubs.result.ResultRequest, com.students_management.stubs.result.ResultResponse> getGetResultForStudentMethod;
      ...
      synchronized (ResultServiceGrpc.class) {
        if ((getGetResultForStudentMethod = ResultServiceGrpc.getGetResultForStudentMethod) == null) {
          ResultServiceGrpc.getGetResultForStudentMethod = getGetResultForStudentMethod =
              io.grpc.MethodDescriptor.<com.students_management.stubs.result.ResultRequest, com.students_management.stubs.result.ResultResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getResultForStudent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.students_management.stubs.result.ResultRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.students_management.stubs.result.ResultResponse.getDefaultInstance()))
  ...
  public static abstract class ResultServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getResultForStudent(com.students_management.stubs.result.ResultRequest request,
        io.grpc.stub.StreamObserver<com.students_management.stubs.result.ResultResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.students_management.stubs.result.ResultRequest,
                com.students_management.stubs.result.ResultResponse>(
  ...
  public static final class ResultServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ResultServiceBlockingStub> {
    ...
    /**
     */
    public com.students_management.stubs.result.ResultResponse getResultForStudent(com.students_management.stubs.result.ResultRequest request) {
  ...
  public static final class ResultServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ResultServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.students_management.stubs.result.ResultResponse> getResultForStudent(
        com.students_management.stubs.result.ResultRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_RESULT_FOR_STUDENT:
          serviceImpl.getResultForStudent((com.students_management.stubs.result.ResultRequest) request,
              (io.grpc.stub.StreamObserver<com.students_management.stubs.result.ResultResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ResultServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.students_management.stubs.result.Result.getDescriptor();
    }

...
public class CalculatorLocator extends org.apache.axis.client.Service implements soap.client.Calculator {
    ...
    public soap.client.CalculatorSoap_PortType getCalculatorSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            soap.client.CalculatorSoap12Stub _stub = new soap.client.CalculatorSoap12Stub(portAddress, this);
    ...
    public soap.client.CalculatorSoap_PortType getCalculatorSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            soap.client.CalculatorSoap_BindingStub _stub = new soap.client.CalculatorSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (soap.client.CalculatorSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                soap.client.CalculatorSoap12Stub _stub = new soap.client.CalculatorSoap12Stub(new java.net.URL(CalculatorSoap12_address), this);
                _stub.setPortName(getCalculatorSoap12WSDDServiceName());
                return _stub;
            }
            if (soap.client.CalculatorSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                soap.client.CalculatorSoap_BindingStub _stub = new soap.client.CalculatorSoap_BindingStub(new java.net.URL(CalculatorSoap_address), this);
                _stub.setPortName(getCalculatorSoapWSDDServiceName());
                return _stub;
            }
        }
